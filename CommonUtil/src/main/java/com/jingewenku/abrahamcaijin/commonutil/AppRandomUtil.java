...
public class AppRandomUtil {
     ...
     * @param length
     * @return
     * @see AppRandomUtil#getRandom(String source, int length)
     */
     ...
     *         <li>else see {@link AppRandomUtil#getRandom(char[] sourceChar, int length)}</li>
     *         </ul>
     */
    public static String getRandom(String source, int length) {
        return AppStringUtils.isEmpty(source) ? null : getRandom(source.toCharArray(), length);
    }
