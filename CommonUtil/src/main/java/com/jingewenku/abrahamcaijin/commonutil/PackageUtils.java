...
import com.jingewenku.abrahamcaijin.commonutil.AppShellMgr.CommandResult;
...
public class PackageUtils {
    ...
    public static final int install(Context context, String filePath) {
        if (PackageUtils.isSystemApplication(context) || AppShellMgr.checkRootPermission()) {
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        CommandResult commandResult = AppShellMgr.execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static Boolean isTopActivity(Context context, String packageName) {
        if (context == null || AppStringUtils.isEmpty(packageName)) {
            return null;
        }
    ...
    public static int getInstallLocation() {
        CommandResult commandResult = AppShellMgr.execCommand(
